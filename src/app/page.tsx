...
import Logo from '../../public/logo_transparant.svg';
    ...
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      <div className="font-mono z-10 w-full max-w-5xl items-center justify-between text-sm lg:flex">
        ...
        <div className="from-white via-white dark:from-black dark:via-black fixed bottom-0 left-0 flex h-48 w-full items-end justify-center bg-gradient-to-t lg:static lg:h-auto lg:w-auto lg:bg-none">
          ...
          >
            By <Logo width={100} height={50} />
          </a>
        </div>
      </div>

      <div className="before:from-white before:to-transparent after:from-sky-200 after:via-blue-200 before:dark:from-transparent before:dark:to-blue-700 after:dark:from-sky-900 relative z-[-1] flex place-items-center before:absolute before:h-[300px] before:w-[480px] before:-translate-x-1/2 before:rounded-full before:bg-gradient-radial before:blur-2xl before:content-[''] after:absolute after:-z-20 after:h-[180px] after:w-[240px] after:translate-x-1/3 after:bg-gradient-conic after:blur-2xl after:content-[''] before:dark:bg-gradient-to-br before:dark:opacity-10 after:dark:via-[#0141ff] after:dark:opacity-40 before:lg:h-[360px]">
        <Image
